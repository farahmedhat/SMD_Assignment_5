...
function Items({ done: doneHeading, onPressItem ,onPressDelete }) {
  ...
  const heading = doneHeading ? "DONE !" : "Todo";
  ...
  return (
    <View style={styles.sectionContainer}>
      ...
      {items.map(({ id, done, value }) => (
        ...
        >
        <Button title={done ? "Delete":"Done"} onPress={() => onPressItem && onPressItem(id)}></Button>
        {!done ? <Button title={ "Delete"} onPress={() => onPressDelete && onPressDelete(id)}></Button> :null }
